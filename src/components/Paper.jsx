  ...
  return (
    <div className="container">
      <div className="text-block">
        ...
        <div className="grid">
            <div className="row">
              <LazyLoadVideo className="col" src="img/work/paper/papermathquestionssquare.mp4" autoPlay muted loop playsInline alt="Maths & Questions Prototype by Lukas Moro." placeholder="img/work/paper/papermathquestionssquare-placeholder.jpg"/>
              <LazyLoadVideo className="col" src="img/work/paper/papermarkcommentsquare.mp4" autoPlay muted loop playsInline alt="Mark & Comment Prototype by Lukas Moro." placeholder="img/work/paper/papermarkcommentsquare-placeholder.jpg"/>
            </div>
            <div className='row'>
        ...
        <div className="grid">
          <div className="row">
            <LazyLoadVideo className="col" src="img/work/paper/papermathquestionswide.mp4" alt="Maths & Questions Prototype by Lukas Moro." autoPlay muted loop playsInline placeholder="img/work/paper/papermathquestionswide-placeholder.jpg"/>
          </div>
        </div>
