  ...
  return (
    <div className="container"  >
      <div className="text-block">
          ...
          <p>
            This project was created during a 10-weeks course, together with Regina Gensinger, Rohit Dongre and Charlotte Phillippe. My contribution was the technical sketching & prototyping. <br /> <br />
